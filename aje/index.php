    ...
    <html lang="pt-br">
        ...
        <body>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item <?php if($linhaRes['ordem']==1) echo "active";?>">
        ...
        <div class="container">
            <div class="col-md-4">
                <h3>Facebook</h3>
                <div class="fb-page" data-href="https://www.facebook.com/aje.matogrossodosul" data-tabs="eventos" data-small-header="false"data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
        ...
        <div class="container">
            <div class="col-md-6">
                <p>Copyright &copy; <script> document.write(years); </script> Associação dos Jovens Empreendedores.</p>
            </div>
            <div class="col-md-6">
    ...
    <script>(function (d, s, id) {var js, fjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.6&appId=1432431656988526"; fjs.parentNode.insertBefore(js, fjs); }(document, 'script', 'facebook-jssdk'));</script>
    <script> window.jQuery || document.write('<script src="../../assets/js/vendor/jquery.min.js"><\/script>') </script>
    <script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script> <!-- Just to make our placeholder images work. Don't actually copy the next line! --> <script src="http://getbootstrap.com/assets/js/vendor/holder.min.js"></script> <!-- IE10 viewport hack for Surface/desktop Windows 8 bug --> <script src="http://getbootstrap.com/assets/js/ie10-viconfiewport-bug-workaround.js"></script> <script src="https://cdn.jsdelivr.net/scrollreveal.js/3.1.4/scrollreveal.min.js"></script>
